  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 w-full text-[15px]">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
         ...
         <div className={`p-4 rounded-2xl flex items-center gap-4 transition-all duration-700 ${
           orders.length >= 5 ? 'bg-emerald-50 border border-emerald-100' : 'bg-gray-50 border border-gray-100'
         }`}>
           ...
           {orders.map((order) => (
             <div key={order.id} className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden group hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-500">
                <div className="flex flex-col md:flex-row">
                   ...
                   <div className={`w-full md:w-56 p-8 flex flex-col justify-center items-center text-center gap-6 ${
                     order.status === 'Arriving Tomorrow' ? 'bg-emerald-50/50' : 'bg-gray-50/30'
                   } border-r border-gray-100`}>
                      <div className="relative">
                         <div className={`p-5 rounded-3xl shadow-lg ring-4 ring-white transition-all duration-700 ${
                           order.status === 'Arriving Tomorrow' ? 'bg-emerald-600 text-white animate-pulse' : 'bg-white text-blue-500'
                         }`}>
                      ...
                      <div>
                         ...
                         <p className={`font-black text-sm uppercase ${
                           order.status === 'Arriving Tomorrow' ? 'text-emerald-600' : 'text-blue-500'
                         }`}>{order.status}</p>
                      </div>
                   </div>
                   ...
                   <div className="flex-1 p-8 grid grid-cols-1 lg:grid-cols-4 gap-12">
                      ...
                      <div className="flex flex-col justify-between items-start lg:items-end">
                         ...
                         <div className="flex gap-2">
                           <button className="mt-4 flex items-center justify-center p-2.5 bg-gray-50 text-gray-400 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all border border-gray-100" title="View Official Receipt">
                             <FileText className="w-4 h-4" />
                           </button>
                           <button className="mt-4 flex items-center justify-center p-2.5 bg-gray-50 text-gray-400 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all border border-gray-100" title="Pulse Analytics">
